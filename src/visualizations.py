...
def make_dashboard(
	...
	items.append(html.H2("Figure 1"))
	items.append(dcc.Graph(
		figure=px.histogram(state_df, x="housing_cost", title ="Housing Cost Distribution", nbins = 50)
	
	))
	items.append(html.H2("Figure 2"))
	...
	items.append(html.H2("Figure 18"))
	items.append(dcc.Graph(
		figure=px.scatter(
			state_df,
			x="housing_cost",
	...
	items.append(html.H2("Figure 25"))
	items.append(dcc.Graph(
		figure=px.scatter(
			df,
			x="taxes",
	...
	items.append(html.H2("Figure 3"))
	items.append(dcc.Graph(
		figure=px.histogram(state_df, x="transportation_cost", title ="Transportation Cost By State", nbins = 50)
	))
	items.append(html.H2("Figure 4"))
	items.append(html.Iframe(
		srcDoc=open(
			create_choropleth_map(
				geometries,
	...
	items.append(html.H2("Figure 6"))
	items.append(dcc.Graph(
		figure=px.histogram(state_df, x="healthcare_cost", title ="Healthcare Cost By State", nbins = 50)
	))
	items.append(html.H2("Figure 7"))
	items.append(html.Iframe(
		srcDoc=open(
			create_choropleth_map(
				geometries,
	...
	items.append(dcc.Graph(
		...
		#figure=px.box(df, x="county", y="total_cost")
	))
	items.append(html.H2("Figure 30"))
	items.append(dcc.Graph(
		figure=px.box(
			df,
			x="parents",
			y="median_family_income", #childcare_cost
			points="outliers"  # or "all" if you want full density
		)
	))
	items.append(html.H2("Figure 11"))
	items.append(dcc.Graph(
		figure=px.histogram(state_df, "state", "median_family_income", title ="Median Income By State")
	))
	items.append(html.H2("Figure 12"))
	items.append(html.Iframe(
		srcDoc=open(
			create_choropleth_map(
				geometries,
	...
	items.append(html.H2("Figure 17"))
	items.append(dcc.Graph(
		figure=px.scatter(
			state_df,
	...
	items.append(html.H2("Figure 16"))
	items.append(dcc.Graph(
		figure=px.scatter(
			state_df,
			x="childcare_cost",
	...
	items.append(html.H2("Figure 29"))
	items.append(dcc.Graph(
		figure=px.box(
			df,
			x="children",
			y="childcare_cost", #childcare_cost
			points="outliers"  # or "all" if you want full density
		)
	))
	items.append(html.H2("Figure 20"))
	items.append(dcc.Graph(
	...
	items.append(html.H2("Figure 10"))
	items.append(dcc.Graph(
	...
	# Family Makeup
	items.append(html.H1("Family Makeup"))
	items.append(html.H2("Figure 14"))
	items.append(dcc.Graph(
		figure=px.pie(
			summary_df,
	...
	items.append(html.H2("Figure 28"))
	items.append(dcc.Graph(
		figure=px.box(
			df,
			x="family_size",
	...
	# Summary
	items.append(html.H2("Figure 19"))
	items.append(dcc.Graph(
		figure=px.scatter(
			state_df,
			x="total_cost",
			...
			trendline="ols",
			labels={
				"total_cost": "Total Household Expenditures",
				"taxes": "Taxes (USD/Household)"
			},
			title="Total Expenditures vs Taxes"
		)
	))
	items.append(html.H2("Figure 22"))
	items.append(dcc.Graph(
    figure=go.Figure(
        data=go.Heatmap(
            z=corr.values,
	...
	items.append(html.H2("Figure 26"))
	...
	items.append(html.H2("Figure 27"))
	items.append(dcc.Graph(figure = px.scatter_3d(
		state_df,
		x = "childcare_cost",
		y = "taxes",
	...
	items.append(html.H2("Figure 31"))
	items.append(html.Iframe(
		srcDoc=open(
			create_choropleth_map(
				geometries,
	...
	# Food costs
	items.append(html.H2("Figure 24"))
	items.append(dcc.Graph(
		figure=px.scatter(
			df,
			x="food_cost",
